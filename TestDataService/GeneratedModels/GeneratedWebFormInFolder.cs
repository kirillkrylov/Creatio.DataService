...
{
	[CObject(RootSchemaName = "GeneratedWebFormInFolder")]
	public class GeneratedWebFormInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="GeneratedWebFormFolder:FolderId")]
		public GeneratedWebFormFolder Folder { get; set; }
		#endregion
