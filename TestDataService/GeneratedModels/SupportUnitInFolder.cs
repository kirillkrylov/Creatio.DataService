...
{
	[CObject(RootSchemaName = "SupportUnitInFolder")]
	public class SupportUnitInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SupportUnitFolder:FolderId")]
		public SupportUnitFolder Folder { get; set; }
		#endregion
