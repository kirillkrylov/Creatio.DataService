...
{
	[CObject(RootSchemaName = "OrderFolder")]
	public class OrderFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="OrderFolder:ParentId")]
		public OrderFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="OrderFolder:ParentId")]
		public virtual ICollection<OrderFolder> OrderFolderByParent { get; set; }
		[CProperty(Association ="OrderInFolder:FolderId")]
		public virtual ICollection<OrderInFolder> OrderInFolderByFolder { get; set; }
		#endregion
	}
}
