...
{
	[CObject(RootSchemaName = "SysModuleReportLczOld")]
	public class SysModuleReportLczOld : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysModuleReport:RecordId")]
		public SysModuleReport Record { get; set; }
		#endregion
