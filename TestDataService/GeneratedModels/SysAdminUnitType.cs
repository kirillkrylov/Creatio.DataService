...
{
	[CObject(RootSchemaName = "SysAdminUnitType")]
	public class SysAdminUnitType : BaseEntity
	{
		#region Values
		...
		public virtual ICollection<VwSysAdminUnit> VwSysAdminUnitBySysAdminUnitType { get; set; }
		#endregion
	}
}
