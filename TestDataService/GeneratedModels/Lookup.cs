...
namespace Creatio.DataService.Models
{
	...
	public class Lookup : BaseEntity
	{
		...
		#region Associations
		[CProperty(Association ="LookupInFolder:LookupId")]
		public virtual ICollection<LookupInFolder> LookupInFolderByLookup { get; set; }
		[CProperty(Association ="LookupInTag:EntityId")]
		public virtual ICollection<LookupInTag> LookupInTagByEntity { get; set; }
		#endregion
	}
}
