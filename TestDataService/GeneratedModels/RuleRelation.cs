...
namespace Creatio.DataService.Models
{
	...
	public class RuleRelation : BaseEntity
	{
		...
		private Guid _EntitySchemaColumnUId;
		[CProperty(ColumnPath ="EntitySchemaColumnUId")]
		public Guid EntitySchemaColumnUId
		{
			get{return _EntitySchemaColumnUId;}
			set
			{
				_EntitySchemaColumnUId = value;
				OnPropertyChanged();
			}
		}
		private Guid _EntitySchemaSearchColumnUId;
		[CProperty(ColumnPath ="EntitySchemaSearchColumnUId")]
		public Guid EntitySchemaSearchColumnUId
		{
			get{return _EntitySchemaSearchColumnUId;}
			set
			{
				_EntitySchemaSearchColumnUId = value;
				OnPropertyChanged();
			}
		}
		private Guid _EntitySchemaSearchUId;
		[CProperty(ColumnPath ="EntitySchemaSearchUId")]
		public Guid EntitySchemaSearchUId
		{
			get{return _EntitySchemaSearchUId;}
			set
			{
				_EntitySchemaSearchUId = value;
				OnPropertyChanged();
			}
		}
