...
namespace Creatio.DataService.Models
{
	...
	public class ForecastItem : BaseEntity
	{
		...
		private Guid _DimensionValueId;
		[CProperty(ColumnPath ="DimensionValueId")]
		public Guid DimensionValueId
		{
			get{return _DimensionValueId;}
			set
			{
				_DimensionValueId = value;
				OnPropertyChanged();
			}
		}
		private Guid _ForecastDimensionId;
		[CProperty(ColumnPath ="ForecastDimensionId")]
		public Guid ForecastDimensionId
		{
			get{return _ForecastDimensionId;}
			set
			{
				_ForecastDimensionId = value;
				OnPropertyChanged();
			}
		}
