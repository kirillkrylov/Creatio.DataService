...
{
	[CObject(RootSchemaName = "PartnershipInFolder")]
	public class PartnershipInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="PartnershipFolder:FolderId")]
		public PartnershipFolder Folder { get; set; }
		#endregion
