...
{
	[CObject(RootSchemaName = "Completeness")]
	public class Completeness : BaseEntity
	{
		#region Values
		...
		[CProperty(ColumnPath ="ResultColumnName")]
		public string ResultColumnName
		{
			get{return _ResultColumnName;}
			set
			{
				_ResultColumnName = value;
				OnPropertyChanged();
			}
		}
		private string _Scale;
		[CProperty(ColumnPath ="Scale")]
		public string Scale
		{
			get{return _Scale;}
			set
		...
		[CProperty(ColumnPath ="TypeColumnName")]
		public string TypeColumnName
		{
			get{return _TypeColumnName;}
			set
			{
		...
		#region Associations
		[CProperty(Association ="CompletenessParameter:CompletenessId")]
		public virtual ICollection<CompletenessParameter> CompletenessParameterByCompleteness { get; set; }
		#endregion
	}
}
