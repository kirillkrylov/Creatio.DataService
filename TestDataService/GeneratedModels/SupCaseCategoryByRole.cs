...
namespace Creatio.DataService.Models
{
	...
	public class SupCaseCategoryByRole : BaseEntity
	{
		...
		private Guid _SupCaseCategoryId;
		[CProperty(ColumnPath ="SupCaseCategoryId")]
		public Guid SupCaseCategoryId
		{
			get{return _SupCaseCategoryId;}
			set
			{
				_SupCaseCategoryId = value;
				OnPropertyChanged();
			}
		}
		private Guid _SupSysAdminUnitId;
		[CProperty(ColumnPath ="SupSysAdminUnitId")]
		public Guid SupSysAdminUnitId
		{
			get{return _SupSysAdminUnitId;}
			set
			{
				_SupSysAdminUnitId = value;
				OnPropertyChanged();
			}
		}
		#endregion
