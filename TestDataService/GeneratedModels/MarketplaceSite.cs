...
{
	[CObject(RootSchemaName = "MarketplaceSite")]
	public class MarketplaceSite : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="MarketplaceApplication:MarketplaceSiteId")]
		public virtual ICollection<MarketplaceApplication> MarketplaceApplicationByMarketplaceSite { get; set; }
		#endregion
	}
}
