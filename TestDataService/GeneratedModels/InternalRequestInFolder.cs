...
{
	[CObject(RootSchemaName = "InternalRequestInFolder")]
	public class InternalRequestInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="InternalRequestFolder:FolderId")]
		public InternalRequestFolder Folder { get; set; }
		#endregion
