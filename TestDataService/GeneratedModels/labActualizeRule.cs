...
namespace Creatio.DataService.Models
{
	...
	public class labActualizeRule : BaseEntity
	{
		...
		private Guid _labCaseCategoryId;
		[CProperty(ColumnPath ="labCaseCategoryId")]
		public Guid labCaseCategoryId
		{
			get{return _labCaseCategoryId;}
			set
			{
				_labCaseCategoryId = value;
				OnPropertyChanged();
			}
		}
		private int _labDelay;
		[CProperty(ColumnPath ="labDelay")]
		public int labDelay
		{
			get{return _labDelay;}
			set
			{
				_labDelay = value;
				OnPropertyChanged();
		...
		private Guid _labEmailTemplateId;
		[CProperty(ColumnPath ="labEmailTemplateId")]
		public Guid labEmailTemplateId
		{
			get{return _labEmailTemplateId;}
			set
			{
				_labEmailTemplateId = value;
				OnPropertyChanged();
			}
		}
