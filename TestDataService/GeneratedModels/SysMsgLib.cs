...
namespace Creatio.DataService.Models
{
	...
	public class SysMsgLib : BaseEntity
	{
		...
		{
			get{return _CtiProviderName;}
			set
			{
				_CtiProviderName = value;
				OnPropertyChanged();
			}
		}
		...
		{
			get{return _LicOperations;}
			set
			{
				_LicOperations = value;
				OnPropertyChanged();
			}
		}
		...
		{
			get{return _SetupPageSchemaName;}
			set
			{
				_SetupPageSchemaName = value;
				OnPropertyChanged();
			}
		}
		#endregion
