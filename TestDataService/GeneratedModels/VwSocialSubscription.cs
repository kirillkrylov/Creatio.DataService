...
{
	[CObject(RootSchemaName = "VwSocialSubscription")]
	public class VwSocialSubscription : BaseEntity
	{
		#region Values
		...
		private Guid _SocialMessageId;
		[CProperty(ColumnPath ="SocialMessageId")]
		public Guid SocialMessageId
		{
			get{return _SocialMessageId;}
			set
			{
				_SocialMessageId = value;
				OnPropertyChanged();
			}
		}
