...
{
	[CObject(RootSchemaName = "ExternalAccessInFolder")]
	public class ExternalAccessInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ExternalAccessFolder:FolderId")]
		public ExternalAccessFolder Folder { get; set; }
		#endregion
