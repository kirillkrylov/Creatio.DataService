...
{
	[CObject(RootSchemaName = "OrderPayer")]
	public class OrderPayer : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="Order:PayerId")]
		public virtual ICollection<Order> OrderByPayer { get; set; }
		#endregion
	}
}
