...
{
	[CObject(RootSchemaName = "BonusFolder")]
	public class BonusFolder : BaseEntity
	{
		#region Values
		...
		#region Navigation
		[CProperty(Navigation ="BonusFolder:ParentId")]
		public BonusFolder Parent { get; set; }
		...
		#region Associations
		[CProperty(Association ="BonusFolder:ParentId")]
		public virtual ICollection<BonusFolder> BonusFolderByParent { get; set; }
		[CProperty(Association ="BonusInFolder:FolderId")]
		public virtual ICollection<BonusInFolder> BonusInFolderByFolder { get; set; }
		#endregion
	}
}
