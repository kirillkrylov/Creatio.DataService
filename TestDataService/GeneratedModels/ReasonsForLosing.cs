...
namespace Creatio.DataService.Models
{
	...
	public class ReasonsForLosing : BaseEntity
	{
		...
		private Guid _DetailReasonId;
		[CProperty(ColumnPath ="DetailReasonId")]
		public Guid DetailReasonId
		{
			get{return _DetailReasonId;}
			set
			{
				_DetailReasonId = value;
				OnPropertyChanged();
			}
		}
		private Guid _Id;
		...
		private Guid _LosingCompetitorReasonId;
		[CProperty(ColumnPath ="LosingCompetitorReasonId")]
		public Guid LosingCompetitorReasonId
		{
			get{return _LosingCompetitorReasonId;}
			set
			{
				_LosingCompetitorReasonId = value;
				OnPropertyChanged();
			}
		}
