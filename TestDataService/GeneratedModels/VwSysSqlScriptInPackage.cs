...
{
	[CObject(RootSchemaName = "VwSysSqlScriptInPackage")]
	public class VwSysSqlScriptInPackage : BaseEntity
	{
		#region Values
		...
		private int _SysSQLScriptLevel;
		[CProperty(ColumnPath ="SysSQLScriptLevel")]
		public int SysSQLScriptLevel
		{
			get{return _SysSQLScriptLevel;}
			set
			{
				_SysSQLScriptLevel = value;
				OnPropertyChanged();
			}
		}
