...
{
	[CObject(RootSchemaName = "VwSysSchemaInfo")]
	public class VwSysSchemaInfo : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="EmailTemplate:ObjectId")]
		...
		public virtual ICollection<VwSysLookup> VwSysLookupBySysGridPageSchemaU { get; set; }
		[CProperty(Association ="VwSysLookup:SysEntitySchemaUId")]
		public virtual ICollection<VwSysLookup> VwSysLookupBySysEntitySchemaU { get; set; }
		#endregion
	}
}
