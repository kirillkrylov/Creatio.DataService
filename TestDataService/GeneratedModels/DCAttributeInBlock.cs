...
namespace Creatio.DataService.Models
{
	...
	public class DCAttributeInBlock : BaseEntity
	{
		...
		private Guid _DCAttributeId;
		[CProperty(ColumnPath ="DCAttributeId")]
		public Guid DCAttributeId
		{
			get{return _DCAttributeId;}
			set
			{
				_DCAttributeId = value;
				OnPropertyChanged();
			}
		}
		private Guid _DCTemplateBlockId;
		[CProperty(ColumnPath ="DCTemplateBlockId")]
		public Guid DCTemplateBlockId
		{
			get{return _DCTemplateBlockId;}
			set
			{
				_DCTemplateBlockId = value;
				OnPropertyChanged();
			}
		}
		private Guid _Id;
