...
{
	[CObject(RootSchemaName = "PsDeliveryVisa")]
	public class PsDeliveryVisa : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="PsDeliveryVisaRole:RoleId")]
		public PsDeliveryVisaRole Role { get; set; }
