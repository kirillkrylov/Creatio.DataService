...
{
	[CObject(RootSchemaName = "VwTsSalesCareer")]
	public class VwTsSalesCareer : BaseEntity
	{
		#region Values
		...
		private DateTime _PositionPeriod;
		[CProperty(ColumnPath ="PositionPeriod")]
		public DateTime PositionPeriod
		{
			get{return _PositionPeriod;}
			set
			{
				_PositionPeriod = value;
				OnPropertyChanged();
			}
		}
