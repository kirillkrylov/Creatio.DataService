...
{
	[CObject(RootSchemaName = "ActivityFile")]
	public class ActivityFile : BaseEntity
	{
		...
		[CProperty(ColumnPath ="ErrorOnUpload")]
		public string ErrorOnUpload
		{
			get{return _ErrorOnUpload;}
			set
			{
				_ErrorOnUpload = value;
				OnPropertyChanged();
			}
		}
		private string _ExternalStorageProperties;
		[CProperty(ColumnPath ="ExternalStorageProperties")]
		public string ExternalStorageProperties
		{
			get{return _ExternalStorageProperties;}
			set
			{
				_ExternalStorageProperties = value;
				OnPropertyChanged();
			}
		}
		private Guid _Id;
