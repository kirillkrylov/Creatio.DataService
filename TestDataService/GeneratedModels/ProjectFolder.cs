...
{
	[CObject(RootSchemaName = "ProjectFolder")]
	public class ProjectFolder : BaseEntity
	{
		...
		[CProperty(Navigation ="ProjectFolder:ParentId")]
		public ProjectFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="ProjectFolder:ParentId")]
		public virtual ICollection<ProjectFolder> ProjectFolderByParent { get; set; }
		[CProperty(Association ="ProjectInFolder:FolderId")]
		public virtual ICollection<ProjectInFolder> ProjectInFolderByFolder { get; set; }
		#endregion
	}
}
