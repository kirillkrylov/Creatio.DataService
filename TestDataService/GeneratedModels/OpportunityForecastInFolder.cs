...
{
	[CObject(RootSchemaName = "OpportunityForecastInFolder")]
	public class OpportunityForecastInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="OpportunityForecastFolder:FolderId")]
		public OpportunityForecastFolder Folder { get; set; }
		#endregion
