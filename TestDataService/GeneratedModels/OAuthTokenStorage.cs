...
{
	[CObject(RootSchemaName = "OAuthTokenStorage")]
	public class OAuthTokenStorage : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="MailboxSyncSettings:OAuthTokenStorageId")]
		public virtual ICollection<MailboxSyncSettings> MailboxSyncSettingsByOAuthTokenStorage { get; set; }
		#endregion
	}
}
