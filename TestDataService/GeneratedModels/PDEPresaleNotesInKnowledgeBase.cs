...
{
	[CObject(RootSchemaName = "PDEPresaleNotesInKnowledgeBase")]
	public class PDEPresaleNotesInKnowledgeBase : BaseEntity
	{
		#region Values
		...
		private string _PDENotes;
		[CProperty(ColumnPath ="PDENotes")]
		public string PDENotes
		{
			get{return _PDENotes;}
			set
			{
				_PDENotes = value;
				OnPropertyChanged();
