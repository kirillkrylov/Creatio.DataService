...
{
	[CObject(RootSchemaName = "TsStaffGoalVisa")]
	public class TsStaffGoalVisa : BaseEntity
	{
		#region Values
		...
		private Guid _StaffGoalId;
		[CProperty(ColumnPath ="StaffGoalId")]
		public Guid StaffGoalId
		{
			get{return _StaffGoalId;}
			set
			{
				_StaffGoalId = value;
				OnPropertyChanged();
		...
		[CProperty(Navigation ="TsStaffGoal:StaffGoalId")]
		public TsStaffGoal StaffGoal { get; set; }
