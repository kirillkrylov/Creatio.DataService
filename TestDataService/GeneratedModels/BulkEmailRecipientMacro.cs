...
{
	[CObject(RootSchemaName = "BulkEmailRecipientMacro")]
	public class BulkEmailRecipientMacro : BaseEntity
	{
		#region Values
		...
		[CProperty(ColumnPath ="RecipientUId")]
		public Guid RecipientUId
		{
			get{return _RecipientUId;}
			set
			{
				_RecipientUId = value;
				OnPropertyChanged();
