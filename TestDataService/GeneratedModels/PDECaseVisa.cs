...
{
	[CObject(RootSchemaName = "PDECaseVisa")]
	public class PDECaseVisa : BaseEntity
	{
		#region Values
		...
		private Guid _PDECaseId;
		[CProperty(ColumnPath ="PDECaseId")]
		public Guid PDECaseId
		{
			get{return _PDECaseId;}
			set
			{
				_PDECaseId = value;
				OnPropertyChanged();
		...
		#region Navigation
		[CProperty(Navigation ="Case:PDECaseId")]
		public Case PDECase { get; set; }
