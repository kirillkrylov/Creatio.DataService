...
{
	[CObject(RootSchemaName = "CIFolder")]
	public class CIFolder : BaseEntity
	{
		#region Values
		...
		#region Navigation
		[CProperty(Navigation ="CIFolder:ParentId")]
		public CIFolder Parent { get; set; }
		...
		#region Associations
		[CProperty(Association ="CIFolder:ParentId")]
		public virtual ICollection<CIFolder> CIFolderByParent { get; set; }
		[CProperty(Association ="CIInFolder:FolderId")]
		public virtual ICollection<CIInFolder> CIInFolderByFolder { get; set; }
		#endregion
	}
}
