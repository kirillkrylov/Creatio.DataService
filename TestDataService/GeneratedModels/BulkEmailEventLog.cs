...
{
	[CObject(RootSchemaName = "BulkEmailEventLog")]
	public class BulkEmailEventLog : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="BulkEmailEventResult:ResultId")]
		public BulkEmailEventResult Result { get; set; }
