...
{
	[CObject(RootSchemaName = "PartnerSegment")]
	public class PartnerSegment : BaseEntity
	{
		#region Values
		...
		private decimal _ServicesConditions;
		[CProperty(ColumnPath ="ServicesConditions")]
		public decimal ServicesConditions
		{
			get{return _ServicesConditions;}
			set
			{
				_ServicesConditions = value;
				OnPropertyChanged();
			}
		}
		...
		#region Associations
		[CProperty(Association ="Account:PartnerSegmentId")]
		public virtual ICollection<Account> AccountByPartnerSegment { get; set; }
		[CProperty(Association ="Segment:PartnerSegmentId")]
		public virtual ICollection<Segment> SegmentByPartnerSegment { get; set; }
		#endregion
	}
}
