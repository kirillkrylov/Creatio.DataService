...
{
	[CObject(RootSchemaName = "tsaTermInFolder")]
	public class tsaTermInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="tsaTermFolder:FolderId")]
		public tsaTermFolder Folder { get; set; }
		#endregion
