...
{
	[CObject(RootSchemaName = "AdminUnitFeatureState")]
	public class AdminUnitFeatureState : BaseEntity
	{
		#region Values
		...
		[CProperty(ColumnPath ="FeatureId")]
		...
		private int _FeatureState;
		[CProperty(ColumnPath ="FeatureState")]
		...
		[CProperty(Navigation ="Feature:FeatureId")]
