...
{
	[CObject(RootSchemaName = "BpmonlineBuildInFolder")]
	public class BpmonlineBuildInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="BpmonlineBuildFolder:FolderId")]
		public BpmonlineBuildFolder Folder { get; set; }
