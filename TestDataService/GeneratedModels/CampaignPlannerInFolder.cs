...
{
	[CObject(RootSchemaName = "CampaignPlannerInFolder")]
	public class CampaignPlannerInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="CampaignPlannerFolder:FolderId")]
		public CampaignPlannerFolder Folder { get; set; }
