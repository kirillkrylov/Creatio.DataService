...
{
	[CObject(RootSchemaName = "MarketplaceApplicationInFolder")]
	public class MarketplaceApplicationInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="MarketplaceApplicationFolder:FolderId")]
		public MarketplaceApplicationFolder Folder { get; set; }
		#endregion
