...
{
	[CObject(RootSchemaName = "SysModuleAnalyticsReportLczOld")]
	public class SysModuleAnalyticsReportLczOld : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysModuleAnalyticsReport:RecordId")]
		public SysModuleAnalyticsReport Record { get; set; }
		#endregion
