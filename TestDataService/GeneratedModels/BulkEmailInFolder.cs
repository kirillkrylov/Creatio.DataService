...
{
	[CObject(RootSchemaName = "BulkEmailInFolder")]
	public class BulkEmailInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="BulkEmailFolder:FolderId")]
		public BulkEmailFolder Folder { get; set; }
