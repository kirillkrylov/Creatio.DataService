...
{
	[CObject(RootSchemaName = "GlbCustomerFolder")]
	public class GlbCustomerFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="GlbCustomerFolder:ParentId")]
		public GlbCustomerFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="GlbCustomerFolder:ParentId")]
		public virtual ICollection<GlbCustomerFolder> GlbCustomerFolderByParent { get; set; }
		[CProperty(Association ="GlbCustomerInFolder:FolderId")]
		public virtual ICollection<GlbCustomerInFolder> GlbCustomerInFolderByFolder { get; set; }
		#endregion
	}
}
