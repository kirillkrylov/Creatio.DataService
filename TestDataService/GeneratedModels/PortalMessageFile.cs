...
{
	[CObject(RootSchemaName = "PortalMessageFile")]
	public class PortalMessageFile : BaseEntity
	{
		#region Values
		...
		private Guid _PortalMessageId;
		[CProperty(ColumnPath ="PortalMessageId")]
		public Guid PortalMessageId
		{
			get{return _PortalMessageId;}
			set
			{
				_PortalMessageId = value;
				OnPropertyChanged();
			}
		}
		...
		[CProperty(Navigation ="PortalMessage:PortalMessageId")]
		public PortalMessage PortalMessage { get; set; }
		#endregion
