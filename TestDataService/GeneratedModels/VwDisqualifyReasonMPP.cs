...
{
	[CObject(RootSchemaName = "VwDisqualifyReasonMPP")]
	public class VwDisqualifyReasonMPP : BaseEntity
	{
		#region Values
		...
		private Guid _LeadStageId;
		[CProperty(ColumnPath ="LeadStageId")]
		public Guid LeadStageId
		{
			get{return _LeadStageId;}
			set
			{
				_LeadStageId = value;
				OnPropertyChanged();
