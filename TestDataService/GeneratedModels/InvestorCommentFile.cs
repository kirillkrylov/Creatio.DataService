...
{
	[CObject(RootSchemaName = "InvestorCommentFile")]
	public class InvestorCommentFile : BaseEntity
	{
		#region Values
		...
		private Guid _InvestorCommentId;
		[CProperty(ColumnPath ="InvestorCommentId")]
		public Guid InvestorCommentId
		{
			get{return _InvestorCommentId;}
			set
			{
				_InvestorCommentId = value;
				OnPropertyChanged();
			}
		}
		...
		[CProperty(Navigation ="InvestorComment:InvestorCommentId")]
		public InvestorComment InvestorComment { get; set; }
		#endregion
