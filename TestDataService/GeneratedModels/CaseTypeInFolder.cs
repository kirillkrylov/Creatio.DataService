...
{
	[CObject(RootSchemaName = "CaseTypeInFolder")]
	public class CaseTypeInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="CaseTypeFolder:FolderId")]
		public CaseTypeFolder Folder { get; set; }
