...
{
	[CObject(RootSchemaName = "GlbCustomerKeyPlayerListFile")]
	public class GlbCustomerKeyPlayerListFile : BaseEntity
	{
		#region Values
		...
		private Guid _GlbCustomerKeyPlayerListId;
		[CProperty(ColumnPath ="GlbCustomerKeyPlayerListId")]
		public Guid GlbCustomerKeyPlayerListId
		{
			get{return _GlbCustomerKeyPlayerListId;}
			set
			{
				_GlbCustomerKeyPlayerListId = value;
				OnPropertyChanged();
			}
		}
		private Guid _Id;
