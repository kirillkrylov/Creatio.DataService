...
{
	[CObject(RootSchemaName = "PsJiraEpic")]
	public class PsJiraEpic : BaseEntity
	{
		#region Values
		...
		private string _JiraEpicCaption;
		[CProperty(ColumnPath ="JiraEpicCaption")]
		public string JiraEpicCaption
		{
			get{return _JiraEpicCaption;}
			set
			{
				_JiraEpicCaption = value;
				OnPropertyChanged();
			}
		}
