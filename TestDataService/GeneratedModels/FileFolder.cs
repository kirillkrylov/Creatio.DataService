...
{
	[CObject(RootSchemaName = "FileFolder")]
	public class FileFolder : BaseEntity
	{
		...
		[CProperty(Navigation ="FileFolder:ParentId")]
		...
		#region Associations
		[CProperty(Association ="FileFolder:ParentId")]
		public virtual ICollection<FileFolder> FileFolderByParent { get; set; }
		[CProperty(Association ="FileInFolder:FolderId")]
		public virtual ICollection<FileInFolder> FileInFolderByFolder { get; set; }
		#endregion
	}
}
