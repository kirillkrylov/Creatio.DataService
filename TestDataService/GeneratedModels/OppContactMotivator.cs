...
namespace Creatio.DataService.Models
{
	...
	{
		#region Values
		private Guid _ContactMotivatorId;
		[CProperty(ColumnPath ="ContactMotivatorId")]
		public Guid ContactMotivatorId
		{
			get{return _ContactMotivatorId;}
			set
			{
				_ContactMotivatorId = value;
				OnPropertyChanged();
			}
		}
		...
		private Guid _OpportunityContactId;
		[CProperty(ColumnPath ="OpportunityContactId")]
		public Guid OpportunityContactId
		{
			get{return _OpportunityContactId;}
			set
			{
				_OpportunityContactId = value;
				OnPropertyChanged();
			}
		}
