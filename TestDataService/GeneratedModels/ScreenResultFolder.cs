...
{
	[CObject(RootSchemaName = "ScreenResultFolder")]
	public class ScreenResultFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ScreenResultFolder:ParentId")]
		public ScreenResultFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="ScreenResultFolder:ParentId")]
		public virtual ICollection<ScreenResultFolder> ScreenResultFolderByParent { get; set; }
		[CProperty(Association ="ScreenResultInFolder:FolderId")]
		public virtual ICollection<ScreenResultInFolder> ScreenResultInFolderByFolder { get; set; }
		#endregion
	}
}
