...
{
	[CObject(RootSchemaName = "ReleaseInFolder")]
	public class ReleaseInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ReleaseFolder:FolderId")]
		public ReleaseFolder Folder { get; set; }
		#endregion
