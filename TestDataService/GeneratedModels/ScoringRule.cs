...
namespace Creatio.DataService.Models
{
	...
	public class ScoringRule : BaseEntity
	{
		...
		private Guid _ScoringModelId;
		[CProperty(ColumnPath ="ScoringModelId")]
		public Guid ScoringModelId
		{
			get{return _ScoringModelId;}
			set
			{
				_ScoringModelId = value;
				OnPropertyChanged();
			}
		}
		private decimal _ScoringPoints;
		[CProperty(ColumnPath ="ScoringPoints")]
		public decimal ScoringPoints
		{
			get{return _ScoringPoints;}
			set
			{
				_ScoringPoints = value;
				OnPropertyChanged();
			}
		}
		#endregion
