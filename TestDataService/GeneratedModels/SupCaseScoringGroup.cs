...
namespace Creatio.DataService.Models
{
	...
	public class SupCaseScoringGroup : BaseEntity
	{
		...
		private Guid _SupSysSchemaId;
		[CProperty(ColumnPath ="SupSysSchemaId")]
		public Guid SupSysSchemaId
		{
			get{return _SupSysSchemaId;}
			set
			{
				_SupSysSchemaId = value;
				OnPropertyChanged();
			}
		}
		private int _SupWeight;
		[CProperty(ColumnPath ="SupWeight")]
		public int SupWeight
		{
			get{return _SupWeight;}
			set
			{
				_SupWeight = value;
				OnPropertyChanged();
