...
{
	[CObject(RootSchemaName = "SysClientUnitSchemaDependency")]
	public class SysClientUnitSchemaDependency : BaseEntity
	{
		#region Values
		...
		private Guid _CreatedInSchemaUId;
		[CProperty(ColumnPath ="CreatedInSchemaUId")]
		public Guid CreatedInSchemaUId
		{
			get{return _CreatedInSchemaUId;}
			set
			{
				_CreatedInSchemaUId = value;
				OnPropertyChanged();
			}
		}
		...
		private Guid _ModifiedInSchemaUId;
		[CProperty(ColumnPath ="ModifiedInSchemaUId")]
		public Guid ModifiedInSchemaUId
		{
			get{return _ModifiedInSchemaUId;}
			set
			{
				_ModifiedInSchemaUId = value;
				OnPropertyChanged();
			}
		}
