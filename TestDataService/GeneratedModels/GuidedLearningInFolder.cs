...
{
	[CObject(RootSchemaName = "GuidedLearningInFolder")]
	public class GuidedLearningInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="GuidedLearningFolder:FolderId")]
		public GuidedLearningFolder Folder { get; set; }
		#endregion
