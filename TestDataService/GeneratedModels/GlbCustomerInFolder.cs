...
{
	[CObject(RootSchemaName = "GlbCustomerInFolder")]
	public class GlbCustomerInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="GlbCustomerFolder:FolderId")]
		public GlbCustomerFolder Folder { get; set; }
		#endregion
