...
{
	[CObject(RootSchemaName = "OpportunityForecast")]
	public class OpportunityForecast : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="Activity:OpportunityForecastId")]
		public virtual ICollection<Activity> ActivityByOpportunityForecast { get; set; }
		[CProperty(Association ="OpportunityForecastFile:OpportunityForecastId")]
		public virtual ICollection<OpportunityForecastFile> OpportunityForecastFileByOpportunityForecast { get; set; }
		[CProperty(Association ="OpportunityForecastHistory:OpportunityForecastId")]
		public virtual ICollection<OpportunityForecastHistory> OpportunityForecastHistoryByOpportunityForecast { get; set; }
		[CProperty(Association ="OpportunityForecastInFolder:OpportunityForecastId")]
		public virtual ICollection<OpportunityForecastInFolder> OpportunityForecastInFolderByOpportunityForecast { get; set; }
		[CProperty(Association ="OpportunityForecastInTag:EntityId")]
		public virtual ICollection<OpportunityForecastInTag> OpportunityForecastInTagByEntity { get; set; }
		[CProperty(Association ="OpportunityForecastVisa:OpportunityForecastId")]
		public virtual ICollection<OpportunityForecastVisa> OpportunityForecastVisaByOpportunityForecast { get; set; }
		[CProperty(Association ="TransactionForecast:OpportunityForecastId")]
		public virtual ICollection<TransactionForecast> TransactionForecastByOpportunityForecast { get; set; }
		#endregion
	}
}
