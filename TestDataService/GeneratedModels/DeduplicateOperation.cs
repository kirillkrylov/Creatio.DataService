...
{
	[CObject(RootSchemaName = "DeduplicateOperation")]
	public class DeduplicateOperation : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="DeduplicateExecLocker:OperationId")]
		public virtual ICollection<DeduplicateExecLocker> DeduplicateExecLockerByOperation { get; set; }
		#endregion
	}
}
