...
{
	[CObject(RootSchemaName = "EmployeeFolder")]
	public class EmployeeFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="EmployeeFolder:ParentId")]
		...
		#region Associations
		[CProperty(Association ="EmployeeFolder:ParentId")]
		public virtual ICollection<EmployeeFolder> EmployeeFolderByParent { get; set; }
		[CProperty(Association ="EmployeeInFolder:FolderId")]
		public virtual ICollection<EmployeeInFolder> EmployeeInFolderByFolder { get; set; }
		#endregion
	}
}
