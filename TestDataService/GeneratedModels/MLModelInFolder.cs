...
{
	[CObject(RootSchemaName = "MLModelInFolder")]
	public class MLModelInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="MLModelFolder:FolderId")]
		public MLModelFolder Folder { get; set; }
		#endregion
