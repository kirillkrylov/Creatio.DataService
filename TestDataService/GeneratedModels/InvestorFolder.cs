...
{
	[CObject(RootSchemaName = "InvestorFolder")]
	public class InvestorFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="InvestorFolder:ParentId")]
		public InvestorFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="InvestorFolder:ParentId")]
		public virtual ICollection<InvestorFolder> InvestorFolderByParent { get; set; }
		[CProperty(Association ="InvestorInFolder:FolderId")]
		public virtual ICollection<InvestorInFolder> InvestorInFolderByFolder { get; set; }
		#endregion
	}
}
