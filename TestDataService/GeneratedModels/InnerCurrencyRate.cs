...
namespace Creatio.DataService.Models
{
	...
	{
		#region Values
		private Guid _BasePriceListId;
		[CProperty(ColumnPath ="BasePriceListId")]
		public Guid BasePriceListId
		{
			get{return _BasePriceListId;}
			set
			{
				_BasePriceListId = value;
				OnPropertyChanged();
			}
		}
		...
		private Guid _NewPriceListId;
		[CProperty(ColumnPath ="NewPriceListId")]
		public Guid NewPriceListId
		{
			get{return _NewPriceListId;}
			set
			{
				_NewPriceListId = value;
				OnPropertyChanged();
			}
		}
