...
namespace Creatio.DataService.Models
{
	...
	public class SysDcmSchemaInSettings : BaseEntity
	{
		...
		private Guid _SysDcmSchemaUId;
		[CProperty(ColumnPath ="SysDcmSchemaUId")]
		public Guid SysDcmSchemaUId
		{
			get{return _SysDcmSchemaUId;}
			set
			{
				_SysDcmSchemaUId = value;
				OnPropertyChanged();
			}
		}
		private Guid _SysDcmSettingsId;
		[CProperty(ColumnPath ="SysDcmSettingsId")]
		public Guid SysDcmSettingsId
		{
			get{return _SysDcmSettingsId;}
			set
			{
				_SysDcmSettingsId = value;
				OnPropertyChanged();
			}
		}
		#endregion
