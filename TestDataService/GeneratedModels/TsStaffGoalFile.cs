...
{
	[CObject(RootSchemaName = "TsStaffGoalFile")]
	public class TsStaffGoalFile : BaseEntity
	{
		#region Values
		...
		private Guid _TsStaffGoalId;
		[CProperty(ColumnPath ="TsStaffGoalId")]
		public Guid TsStaffGoalId
		{
			get{return _TsStaffGoalId;}
			set
			{
				_TsStaffGoalId = value;
				OnPropertyChanged();
			}
		}
		...
		[CProperty(Navigation ="TsStaffGoal:TsStaffGoalId")]
		public TsStaffGoal TsStaffGoal { get; set; }
		#endregion
