...
{
	[CObject(RootSchemaName = "ContentBlockFile")]
	public class ContentBlockFile : BaseEntity
	{
		#region Values
		private Guid _ContentBlockId;
		[CProperty(ColumnPath ="ContentBlockId")]
		public Guid ContentBlockId
		{
			get{return _ContentBlockId;}
			set
			{
				_ContentBlockId = value;
				OnPropertyChanged();
			}
		}
		...
		[CProperty(Navigation ="ContentBlock:ContentBlockId")]
