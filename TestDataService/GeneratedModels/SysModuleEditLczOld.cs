...
{
	[CObject(RootSchemaName = "SysModuleEditLczOld")]
	public class SysModuleEditLczOld : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysModuleEdit:RecordId")]
		public SysModuleEdit Record { get; set; }
		#endregion
