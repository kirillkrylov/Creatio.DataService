...
namespace Creatio.DataService.Models
{
	...
	public class VwChange : BaseEntity
	{
		...
		private int _FakeColumn;
		[CProperty(ColumnPath ="FakeColumn")]
		public int FakeColumn
		{
			get{return _FakeColumn;}
			set
			{
				_FakeColumn = value;
				OnPropertyChanged();
		...
		private bool _IsHasRevert;
		[CProperty(ColumnPath ="IsHasRevert")]
		public bool IsHasRevert
		{
			get{return _IsHasRevert;}
			set
			{
				_IsHasRevert = value;
				OnPropertyChanged();
		...
		private decimal _UpdateDuration;
		[CProperty(ColumnPath ="UpdateDuration")]
		public decimal UpdateDuration
		{
