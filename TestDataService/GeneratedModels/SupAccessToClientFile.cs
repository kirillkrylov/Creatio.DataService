...
{
	[CObject(RootSchemaName = "SupAccessToClientFile")]
	public class SupAccessToClientFile : BaseEntity
	{
		#region Values
		...
		private Guid _SupAccessToClientId;
		[CProperty(ColumnPath ="SupAccessToClientId")]
		public Guid SupAccessToClientId
		{
			get{return _SupAccessToClientId;}
			set
			{
				_SupAccessToClientId = value;
				OnPropertyChanged();
			}
		}
		...
		[CProperty(Navigation ="SupAccessToClient:SupAccessToClientId")]
		public SupAccessToClient SupAccessToClient { get; set; }
		#endregion
