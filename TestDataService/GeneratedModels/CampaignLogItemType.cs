...
{
	[CObject(RootSchemaName = "CampaignLogItemType")]
	public class CampaignLogItemType : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="CampaignLog:ActionId")]
		public virtual ICollection<CampaignLog> CampaignLogByAction { get; set; }
		[CProperty(Association ="VwCampaignLog:ActionId")]
		public virtual ICollection<VwCampaignLog> VwCampaignLogByAction { get; set; }
		#endregion
	}
}
