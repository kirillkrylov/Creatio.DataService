...
{
	[CObject(RootSchemaName = "VwSysProcess")]
	public class VwSysProcess : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="CTIProcessAction:ProcessSchemaId")]
		public virtual ICollection<CTIProcessAction> CTIProcessActionByProcessSchema { get; set; }
		#endregion
	}
}
