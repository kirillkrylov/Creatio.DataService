...
{
	[CObject(RootSchemaName = "CaseOriginInCategory")]
	public class CaseOriginInCategory : BaseEntity
	{
		#region Values
		[CProperty(ColumnPath ="CaseCategoryId")]
		public Guid CaseCategoryId { get; set; }
		[CProperty(ColumnPath ="CaseOriginId")]
		...
		[CProperty(Navigation ="CaseOrigin:CaseOriginId")]
