...
namespace Creatio.DataService.Models
{
	...
	{
		#region Values
		private decimal _AmountRangeFrom;
		[CProperty(ColumnPath ="AmountRangeFrom")]
		public decimal AmountRangeFrom
		{
			get{return _AmountRangeFrom;}
			set
			{
				_AmountRangeFrom = value;
				OnPropertyChanged();
			}
		}
		private decimal _AmountRangeTo;
		[CProperty(ColumnPath ="AmountRangeTo")]
		public decimal AmountRangeTo
		{
			get{return _AmountRangeTo;}
			set
			{
				_AmountRangeTo = value;
				OnPropertyChanged();
			}
		}
