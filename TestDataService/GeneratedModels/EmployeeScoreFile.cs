...
{
	[CObject(RootSchemaName = "EmployeeScoreFile")]
	public class EmployeeScoreFile : BaseEntity
	{
		#region Values
		...
		private Guid _EmployeeScoreId;
		[CProperty(ColumnPath ="EmployeeScoreId")]
		public Guid EmployeeScoreId
		{
			get{return _EmployeeScoreId;}
			set
			{
				_EmployeeScoreId = value;
				OnPropertyChanged();
			}
		}
		private Guid _Id;
