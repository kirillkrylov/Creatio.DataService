...
{
	[CObject(RootSchemaName = "GiftFolder")]
	public class GiftFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="GiftFolder:ParentId")]
		public GiftFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="GiftFolder:ParentId")]
		public virtual ICollection<GiftFolder> GiftFolderByParent { get; set; }
		[CProperty(Association ="GiftInFolder:FolderId")]
		public virtual ICollection<GiftInFolder> GiftInFolderByFolder { get; set; }
		#endregion
	}
}
