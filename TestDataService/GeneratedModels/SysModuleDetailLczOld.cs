...
{
	[CObject(RootSchemaName = "SysModuleDetailLczOld")]
	public class SysModuleDetailLczOld : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysModuleDetail:RecordId")]
		public SysModuleDetail Record { get; set; }
		#endregion
