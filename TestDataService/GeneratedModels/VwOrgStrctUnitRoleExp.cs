...
{
	[CObject(RootSchemaName = "VwOrgStrctUnitRoleExp")]
	public class VwOrgStrctUnitRoleExp : BaseEntity
	{
		#region Values
		...
		private Guid _OrgStructureUnitRoleId;
		[CProperty(ColumnPath ="OrgStructureUnitRoleId")]
		public Guid OrgStructureUnitRoleId
		{
			get{return _OrgStructureUnitRoleId;}
			set
			{
				_OrgStructureUnitRoleId = value;
				OnPropertyChanged();
			}
		}
