...
{
	[CObject(RootSchemaName = "MarketplaceProductCategory")]
	public class MarketplaceProductCategory : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="MarketplaceApplication:ProductCategoryId")]
		public virtual ICollection<MarketplaceApplication> MarketplaceApplicationByProductCategory { get; set; }
		#endregion
	}
}
