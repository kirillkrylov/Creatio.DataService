...
{
	[CObject(RootSchemaName = "BudgetInFolder")]
	public class BudgetInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="BudgetFolder:FolderId")]
		public BudgetFolder Folder { get; set; }
