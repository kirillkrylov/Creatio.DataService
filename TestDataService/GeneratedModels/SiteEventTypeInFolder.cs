...
{
	[CObject(RootSchemaName = "SiteEventTypeInFolder")]
	public class SiteEventTypeInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SiteEventTypeFolder:FolderId")]
		public SiteEventTypeFolder Folder { get; set; }
		#endregion
