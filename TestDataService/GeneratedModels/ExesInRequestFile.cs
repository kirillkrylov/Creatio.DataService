...
{
	[CObject(RootSchemaName = "ExesInRequestFile")]
	public class ExesInRequestFile : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="ExesInRequestInFolder:FolderId")]
		public virtual ICollection<ExesInRequestInFolder> ExesInRequestInFolderByFolder { get; set; }
		#endregion
	}
}
