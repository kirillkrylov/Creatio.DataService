...
{
	[CObject(RootSchemaName = "MarketplaceDeveloperCategory")]
	public class MarketplaceDeveloperCategory : BaseEntity
	{
		#region Values
		...
		#region Associations
		[CProperty(Association ="MarketplaceApplication:DeveloperCategoryId")]
		public virtual ICollection<MarketplaceApplication> MarketplaceApplicationByDeveloperCategory { get; set; }
		#endregion
	}
}
