...
{
	[CObject(RootSchemaName = "TsOrderExpenseFolder")]
	public class TsOrderExpenseFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="TsOrderExpenseFolder:ParentId")]
		public TsOrderExpenseFolder Parent { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="TsOrderExpenseFolder:ParentId")]
		public virtual ICollection<TsOrderExpenseFolder> TsOrderExpenseFolderByParent { get; set; }
		[CProperty(Association ="TsOrderExpenseInFolder:FolderId")]
		public virtual ICollection<TsOrderExpenseInFolder> TsOrderExpenseInFolderByFolder { get; set; }
		#endregion
	}
}
