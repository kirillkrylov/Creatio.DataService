...
namespace Creatio.DataService.Models
{
	...
	{
		#region Values
		private string _BusinessProcessCaption;
		[CProperty(ColumnPath ="BusinessProcessCaption")]
		public string BusinessProcessCaption
		{
			get{return _BusinessProcessCaption;}
			set
			{
				_BusinessProcessCaption = value;
				OnPropertyChanged();
			}
		}
		...
		private bool _IsActionWithConfItem;
		[CProperty(ColumnPath ="IsActionWithConfItem")]
		public bool IsActionWithConfItem
		{
			get{return _IsActionWithConfItem;}
			set
			{
				_IsActionWithConfItem = value;
				OnPropertyChanged();
			}
		}
