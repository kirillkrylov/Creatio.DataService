...
namespace Creatio.DataService.Models
{
	...
	public class Activity : BaseEntity
	{
		...
		[CProperty(ColumnPath ="OccurencesId")]
		public Guid OccurencesId { get; set; }
		...
		[CProperty(ColumnPath ="tsatsaTermId")]
		public Guid tsatsaTermId { get; set; }
		...
		[CProperty(Navigation ="GuidedLearningOccurances:OccurencesId")]
		public GuidedLearningOccurances Occurences { get; set; }
		...
		[CProperty(Navigation ="tsaTerm:tsatsaTermId")]
		public tsaTerm tsatsaTerm { get; set; }
		...
		[CProperty(Association ="Certification:SchedulerActivityId")]
		public virtual ICollection<Certification> CertificationBySchedulerActivity { get; set; }
		...
		[CProperty(Association ="GuidedLearningOccurances:RelatedActivityId")]
		public virtual ICollection<GuidedLearningOccurances> GuidedLearningOccurancesByRelatedActivity { get; set; }
