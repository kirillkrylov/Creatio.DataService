...
{
	[CObject(RootSchemaName = "SysModuleActionLczOld")]
	public class SysModuleActionLczOld : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysModuleAction:RecordId")]
		public SysModuleAction Record { get; set; }
		#endregion
