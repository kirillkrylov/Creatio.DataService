...
{
	[CObject(RootSchemaName = "VwVisa")]
	public class VwVisa : BaseEntity
	{
		#region Values
		...
		private Guid _VisaObjectId;
		[CProperty(ColumnPath ="VisaObjectId")]
		public Guid VisaObjectId
		{
			get{return _VisaObjectId;}
			set
			{
				_VisaObjectId = value;
				OnPropertyChanged();
		...
		[CProperty(ColumnPath ="VisaSchemaCaption")]
		public string VisaSchemaCaption
		{
			get{return _VisaSchemaCaption;}
			set
			{
				_VisaSchemaCaption = value;
				OnPropertyChanged();
			}
		}
		private string _VisaSchemaName;
		[CProperty(ColumnPath ="VisaSchemaName")]
		public string VisaSchemaName
		{
			get{return _VisaSchemaName;}
			set
			{
				_VisaSchemaName = value;
				OnPropertyChanged();
			}
		}
		private Guid _VisaSchemaTypeId;
		[CProperty(ColumnPath ="VisaSchemaTypeId")]
		public Guid VisaSchemaTypeId
		{
			get{return _VisaSchemaTypeId;}
			set
			{
				_VisaSchemaTypeId = value;
				OnPropertyChanged();
			}
		}
		private string _VisaTypeName;
		[CProperty(ColumnPath ="VisaTypeName")]
