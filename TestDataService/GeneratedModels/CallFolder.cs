...
{
	[CObject(RootSchemaName = "CallFolder")]
	public class CallFolder : BaseEntity
	{
		#region Values
		...
		#region Navigation
		[CProperty(Navigation ="CallFolder:ParentId")]
		public CallFolder Parent { get; set; }
		...
		#region Associations
		[CProperty(Association ="CallFolder:ParentId")]
		public virtual ICollection<CallFolder> CallFolderByParent { get; set; }
		[CProperty(Association ="CallInFolder:FolderId")]
		public virtual ICollection<CallInFolder> CallInFolderByFolder { get; set; }
		#endregion
	}
}
