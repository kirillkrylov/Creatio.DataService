...
{
	[CObject(RootSchemaName = "ExesInRequestInFolder")]
	public class ExesInRequestInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ExesInRequestFile:FolderId")]
		public ExesInRequestFile Folder { get; set; }
		#endregion
