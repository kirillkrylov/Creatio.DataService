...
{
	[CObject(RootSchemaName = "ConfItemInFolder")]
	public class ConfItemInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ConfItemFolder:FolderId")]
		public ConfItemFolder Folder { get; set; }
