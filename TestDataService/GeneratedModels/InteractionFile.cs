...
{
	[CObject(RootSchemaName = "InteractionFile")]
	public class InteractionFile : BaseEntity
	{
		#region Values
		...
		[CProperty(ColumnPath ="InteractionId")]
		...
		[CProperty(Navigation ="InteractionWithManager:InteractionId")]
		public InteractionWithManager Interaction { get; set; }
		#endregion
