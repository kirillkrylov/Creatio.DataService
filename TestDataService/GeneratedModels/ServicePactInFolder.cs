...
{
	[CObject(RootSchemaName = "ServicePactInFolder")]
	public class ServicePactInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="ServicePactFolder:FolderId")]
		public ServicePactFolder Folder { get; set; }
		#endregion
