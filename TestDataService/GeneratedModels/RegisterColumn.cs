...
namespace Creatio.DataService.Models
{
	...
	public class RegisterColumn : BaseEntity
	{
		...
		private Guid _DefaultValueTypeId;
		[CProperty(ColumnPath ="DefaultValueTypeId")]
		public Guid DefaultValueTypeId
		{
			get{return _DefaultValueTypeId;}
			set
			{
				_DefaultValueTypeId = value;
				OnPropertyChanged();
			}
		}
		...
		private Guid _OneCRegesterColumnId;
		[CProperty(ColumnPath ="OneCRegesterColumnId")]
		public Guid OneCRegesterColumnId
		{
			get{return _OneCRegesterColumnId;}
			set
			{
				_OneCRegesterColumnId = value;
				OnPropertyChanged();
			}
		}
