...
{
	[CObject(RootSchemaName = "SysProcessElementLog")]
	public class SysProcessElementLog : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysProcessLog:SysProcessId")]
		public SysProcessLog SysProcess { get; set; }
		[CProperty(Navigation ="SysProcessStatus:StatusId")]
		public SysProcessStatus Status { get; set; }
		#endregion

		#region Associations
		[CProperty(Association ="SysPrcElementTraceLog:SysProcessElementLogId")]
		public virtual ICollection<SysPrcElementTraceLog> SysPrcElementTraceLogBySysProcessElementLog { get; set; }
		#endregion
	}
}
