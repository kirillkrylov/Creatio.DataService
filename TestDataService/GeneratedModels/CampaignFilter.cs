...
{
	[CObject(RootSchemaName = "CampaignFilter")]
	public class CampaignFilter : BaseEntity
	{
		#region Values
		...
		[CProperty(ColumnPath ="StepTypeId")]
		...
		#region Navigation
		[CProperty(Navigation ="CampaignStepType:StepTypeId")]
