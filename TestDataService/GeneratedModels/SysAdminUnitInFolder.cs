...
{
	[CObject(RootSchemaName = "SysAdminUnitInFolder")]
	public class SysAdminUnitInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="SysAdminUnitFolder:FolderId")]
		public SysAdminUnitFolder Folder { get; set; }
		#endregion
