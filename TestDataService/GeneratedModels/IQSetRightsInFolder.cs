...
{
	[CObject(RootSchemaName = "IQSetRightsInFolder")]
	public class IQSetRightsInFolder : BaseEntity
	{
		#region Values
		...
		[CProperty(Navigation ="IQSetRightsFolder:FolderId")]
		public IQSetRightsFolder Folder { get; set; }
		#endregion
