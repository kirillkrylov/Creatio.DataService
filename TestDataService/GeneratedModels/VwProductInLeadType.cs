...
namespace Creatio.DataService.Models
{
	...
	public class VwProductInLeadType : BaseEntity
	{
		...
		private Guid _ProductFolderId;
		[CProperty(ColumnPath ="ProductFolderId")]
		public Guid ProductFolderId
		{
			get{return _ProductFolderId;}
			set
			{
				_ProductFolderId = value;
				OnPropertyChanged();
			}
		}
		...
		private Guid _ProductTypeInLeadTypeId;
		[CProperty(ColumnPath ="ProductTypeInLeadTypeId")]
		public Guid ProductTypeInLeadTypeId
		{
			get{return _ProductTypeInLeadTypeId;}
			set
			{
				_ProductTypeInLeadTypeId = value;
				OnPropertyChanged();
			}
		}
		#endregion
