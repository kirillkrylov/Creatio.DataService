namespace Creatio.DataService
{
    public class Parameter
    {
        ...
        /// <summary>
        /// Indicates whether the value conversion process should be skipped in Terrasoft.Nui.ServiceModel.DataContract.Parameter.GetValue(Terrasoft.Core.UserConnection,Terrasoft.Core.DataValueType,System.Boolean).
        /// </summary>
        /// <returns></returns>
